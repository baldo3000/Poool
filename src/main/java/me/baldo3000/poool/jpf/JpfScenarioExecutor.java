...
import me.baldo3000.poool.jpf.executor.SafeExecutorBoardUpdater;
...
public class JpfScenarioExecutor {
    ...
    public static void main(String[] args) {
        ...
        var boardUpdater = new SafeExecutorBoardUpdater(gameBalls, bounds, THREADS);
